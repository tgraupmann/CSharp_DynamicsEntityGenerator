...
namespace DynamicsEntityGenerator
{
    public class AutoGeneratorClient
    {
        ...
        void GenerateEntity(string entity, SortedList<string, Type> attributes, SortedList<string, Type> formattedValues)
        {
        ...
        public void GenerateClasses(string[] entities)
        {
            foreach (string entity in entities)
            {
                ...
                if (results != null)
                {
                    ...
                    GenerateEntity(entity, attributes, formattedValues);
                }
            }
        }
    }
